...
function bestRects = getGraspForSelection(I,D,BG,w1,w2,wClass,means,stds,rotAngs,hts,wds,scanStep,modes)
...
while true
    ...
    myBest = onePassDetectionNormForIm(I1,D1,ones(size(D1)),w1,w2,wClass,means,stds,rotAngs,hts,wds,scanStep,modes);
